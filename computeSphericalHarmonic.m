function Y = computeSphericalHarmonic(n,m,th,phi,varargin)
%computeSphericalHarmonic  Spherical harmonic function.
%
%   Y = computeSphericalHarmonic(N,M,TH,PHI) computes the surface spherical harmonic of
...
%
%   Y = computeSphericalHarmonic(N,M,TH,PHI,R) computes the solid spherical harmonic of
...
%
%   Y = computeSphericalHarmonic(__,Name,Value) specifies additional options using one or
